...
import MainListItems, { ListItems } from './ListItems/index'
    ...
    <ThemeProvider theme={mdTheme}>
      <Box sx={{ display: 'flex' }}>
        ...
        <Drawer variant="permanent" open={open} >
          ...
          <Divider />
          <List component="nav">
            <ListItems setPageNum={setPageNum}/>
          </List>
        </Drawer>
        <Box
          component="main"
              ...
              <Grid item xs={12}>
                <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
                {
                  ...
                  (<PropDetailsPage showProperty={showProperty} setShowProperty={setShowProperty}/>):
                   pageNum==1?
                (<Orders />):(<PropertyVerify showProperty={showProperty} setShowProperty={setShowProperty}/>)}
                </Paper>
              </Grid>
            </Grid>
          </Container>
